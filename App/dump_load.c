...
{
#if defined(DUMP_LOAD_RELAY_PORT) && defined(DUMP_LOAD_RELAY_IN_PIN)
    DL_GPIO_setPins(DUMP_LOAD_RELAY_PORT, DUMP_LOAD_RELAY_IN_PIN);
#endif
...
{
#if defined(DUMP_LOAD_RELAY_PORT) && defined(DUMP_LOAD_RELAY_IN_PIN)
    DL_GPIO_clearPins(DUMP_LOAD_RELAY_PORT, DUMP_LOAD_RELAY_IN_PIN);
#endif
