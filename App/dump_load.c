...
{
#if defined(DUMP_LOAD_REALY_PORT) && defined(DUMP_LOAD_REALY_IN2_PIN)
    DL_GPIO_setPins(DUMP_LOAD_REALY_PORT, DUMP_LOAD_REALY_IN2_PIN);
#endif
...
{
#if defined(DUMP_LOAD_REALY_PORT) && defined(DUMP_LOAD_REALY_IN2_PIN)
    DL_GPIO_clearPins(DUMP_LOAD_REALY_PORT, DUMP_LOAD_REALY_IN2_PIN);
#endif
